      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 py-8 sm:py-12">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm text-gray-600">
            Updated At: {policyData?.updated_at ? new Date(policyData.updated_at).toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' }) : new Date().toLocaleDateString('en-US', { day: 'numeric', month: 'long', year: 'numeric' })}
          </p>
        </div>
        ...
        <div
          ...
          dangerouslySetInnerHTML={{ __html: policyData?.content || '<p>No content available.</p>' }}
